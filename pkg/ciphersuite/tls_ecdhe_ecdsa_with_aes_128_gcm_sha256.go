...
func (c *TLSEcdheEcdsaWithAes128GcmSha256) KeyExchangeAlgorithm() dtls.CipherSuiteKeyExchangeAlgorithm {
...
func (c *TLSEcdheEcdsaWithAes128GcmSha256) ID() dtls.CipherSuiteID {
...
func (c *TLSEcdheEcdsaWithAes128GcmSha256) AuthenticationType() dtls.CipherSuiteAuthenticationType {
...
func (c *TLSEcdheEcdsaWithAes128GcmSha256) Encrypt(pkt *recordlayer.RecordLayer, raw []byte) ([]byte, error) {
	...
	if !ok {
		return nil, errors.New("unable to encrypt")
	}
